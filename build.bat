...
clang++ -o .\bin\autobuild.exe .\obj\AutobuildRepo\readAutobuildFile.o .\obj\CompileJob\execute.o .\obj\CompileJob\initObjectFile.o .\obj\SourceGroup\initObjectFiles.o .\obj\Target\initObjectFiles.o .\obj\Target\linkObjects.o .\obj\autobuild.o -I ..\text-parser\include ..\text-parser\bin\text-parser.a